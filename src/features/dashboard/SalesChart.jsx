...
const SalesChart = ({ bookings, numDays }) => {
  ...
  // compute the data structure like "fake data", an array which contains one object each day
  // creating dates with date-fns
  ...
  const data = allDates.map((date) => {
    return {
      ...
      // get all the booking from current date
      totalSales: bookings
